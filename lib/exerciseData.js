...
export const exerciseLibrary = {
  ...
  "wristExtensorStretch": {
    ...
    category: "stretches",
    painRegions: ["wristFlexors", "ulnarSideFlexors"],
  ...
  "isometricUlnarDeviation": {
    ...
    category: "isometrics",
    painRegions: ["ulnarSideExtensors"],
  ...
  "isometricWristUlnarDeviation": {
    id: "isometricWristUlnarDeviation",
    name: "Isometric Wrist Ulnar Deviation*",
    category: "isometrics",
    painRegions: ["ulnarSideFlexors"],
    instructions: "Press the pinky-side of your hand against a stable surface. Apply pressure without moving your wrist.",
    imageUrl: "/images/exercises/isometric-wrist-ulnar-deviation.jpg",
    isFree: true,
    weightType: "none",
    defaultWeight: 0,
    weightUnit: "",
  ...
  "dbWristUlnarDeviation": {
    id: "dbWristUlnarDeviation",
    name: "DB Wrist Ulnar Deviation",
    category: "strength",
    painRegions: ["ulnarSideFlexors"],
    instructions: "Rest your forearm on a table with your hand off the edge, thumb facing up. Hold a dumbbell and lift your hand up toward your pinky side, then lower back down.",
    imageUrl: "/images/exercises/db-wrist-ulnar-deviation.jpg",
    isFree: false,
    weightType: "weight",
    defaultWeight: 2,
    weightUnit: "lbs",
  ...
  "isometricWristFlexionFingers": {
    ...
    imageUrl: "/images/exercises/isometric-wrist-flexion-fingers.jpg",
    isFree: true,
    weightType: "none",
    defaultWeight: 0,
    weightUnit: "",
  ...
  "isometricWristExtensionFingers": {
    ...
    imageUrl: "/images/exercises/isometric-wrist-extension-fingers.jpg",
    isFree: false,
    weightType: "none",
    defaultWeight: 0,
    weightUnit: "",
  ...
  "rubberBandExtensions": {
    ...
    imageUrl: "/images/exercises/rubber-band-extensions.jpg",
    isFree: false,
    weightType: "band",
    defaultWeight: 1,
    weightUnit: "RB",
...
export function getRecommendedExerciseProgram(painRegions, proUser = false) {
  ...
  Object.keys(program).forEach(category => {
    ...
    program[category] = categoryExercises.slice(0, category === 'stretches' ? 3 : 2);
  });
