...
export default function ProgressStatistics() {
  ...
  // Get irritability label based on index value
  function getIrritabilityLabel(index) {
    if (index < 5) return 'Low';
    if (index < 10) return 'Mild-Moderate';
    if (index < 15) return 'Moderate';
    if (index < 20) return 'Moderate-Severe';
    return 'Severe';
  }
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-white border-r p-6 hidden md:block">
          <nav className="space-y-4">
            ...
            <Link href="/progress-statistics" className="block text-gray-800 font-medium hover:text-red-500 font-bold text-red-500">Progress Statistics</Link>
        ...
        <main className="flex-1 p-4 md:p-8">
          ...
          {/* Exercise Prescription Progress */}
